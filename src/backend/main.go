...
//
// That origin is https://17xande.dev, whose /teleprompter/ section is the
// marketing site. The app itself is served from teleprompter.17xande.dev,
// which 'self' already covers, so it is not named again.
